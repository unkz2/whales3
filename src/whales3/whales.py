...
class Whales: 
    ...
    def draw_scaffold(self): 
        ...
        results = Draw.MolsToGridImage(
                                       ...
                                       legends=[x.GetProp("_Name") for x in self.freq_scaffolds_library[:k]]
                                       )
    ...
    def manipulate(self): 
        ...
        self.norm_whales_library, aver, sdv = self._normalize(self.library_whales)
        self.norm_whales_template, average, sdt = self._normalize(self.template_whales, aver=aver, sdv=sdv)
